...
namespace InvAPI.Controllers
{
    ...
    public class EmployersController : ControllerBase
    {
        ...
        public EmployersController(InventarisationDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Employer>> PostEmployer(Employer employer)
        {
            ...
            return CreatedAtAction("GetEmployer", new { id = employer.IdEmpolyer }, employer);
        }
        ...
        {
            return _context.Employers.Any(e => e.IdEmpolyer == id);
        }
    }
}
